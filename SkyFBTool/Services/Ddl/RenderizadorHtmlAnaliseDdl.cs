...
public static class RenderizadorHtmlAnaliseDdl
{
    ...
    private static ModeloRelatorio CriarModelo(ResultadoAnaliseDdl resultado, IdiomaSaida idioma)
    {
        ...
        return new ModeloRelatorio
        {
            ...
            ResumoTabelaLabel = TextoLocalizado.Obter(idioma, "Objects prioritized for remediation", "Objetos priorizados para correção"),
            ...
            BuscaPlaceholder = TextoLocalizado.Obter(idioma, "scope, code or text...", "escopo, código ou texto..."),
