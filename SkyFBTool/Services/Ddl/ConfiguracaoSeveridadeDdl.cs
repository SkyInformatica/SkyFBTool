...
public static class ConfiguracaoSeveridadeDdl
{
    ...
    private static readonly Dictionary<string, string> CodigoAlias = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["REDUNDANT_PREFIX_INDEX"] = "INDICE_REDUNDANTE_PREFIXO",
        ["DUPLICATED_FK"] = "FK_DUPLICADA",
        ["PROCEDURE_WITHOUT_BODY"] = "PROCEDURE_SEM_CORPO",
        ["FUNCTION_WITHOUT_BODY"] = "FUNCTION_SEM_CORPO",
        ["TRIGGER_WITHOUT_BODY"] = "TRIGGER_SEM_CORPO",
        ["PROCEDURE_ONLY_SUSPEND"] = "PROCEDURE_SOMENTE_SUSPEND",
        ["FUNCTION_ONLY_SUSPEND"] = "FUNCTION_SOMENTE_SUSPEND",
        ["TRIGGER_ONLY_SUSPEND"] = "TRIGGER_SOMENTE_SUSPEND",
        ["OPERATIONAL_OIT_OAT_GAP_CRITICAL"] = "OPERACIONAL_GAP_OIT_OAT_ELEVADO",
        ["OPERATIONAL_OIT_OAT_GAP_HIGH"] = "OPERACIONAL_GAP_OIT_OAT_ACIMA_DO_ESPERADO",
        ["OPERATIONAL_OIT_OAT_GAP_MEDIUM"] = "OPERACIONAL_GAP_OIT_OAT_MODERADO",
        ["OPERATIONAL_OAT_OST_GAP_HIGH"] = "OPERACIONAL_GAP_OAT_OST_ELEVADO",
        ["OPERATIONAL_OAT_OST_GAP_MEDIUM"] = "OPERACIONAL_GAP_OAT_OST_ACIMA_DO_ESPERADO",
        ["OPERATIONAL_LONG_ACTIVE_TRANSACTION_CRITICAL"] = "OPERACIONAL_TRANSACAO_ATIVA_LONGA_CRITICA",
