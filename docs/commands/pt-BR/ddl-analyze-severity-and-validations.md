...
| `INDICE_COLUNA_INEXISTENTE` | `high` | Índice aponta para coluna inexistente | Coluna do índice não encontrada | Índice inclui coluna ausente na tabela. Ex.: índice em `VENDAS(DATA_EMISSAO)` sem a coluna `DATA_EMISSAO`. |
