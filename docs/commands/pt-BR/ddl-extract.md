...
Hoje o snapshot inclui tabelas, colunas, domínios, sequências/geradores, chaves primárias, chaves únicas, restrições `CHECK`, chaves estrangeiras e índices de usuário.
