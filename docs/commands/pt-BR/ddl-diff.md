...
Hoje o diff também considera domínios, sequências/geradores, constraints únicas e constraints `CHECK` além de tabelas, colunas, PKs, FKs e índices de usuário.
