...
Hoje o diff também considera domínios, sequências/geradores, views, constraints únicas e constraints `CHECK` além de tabelas, colunas, PKs, FKs e índices de usuário.
