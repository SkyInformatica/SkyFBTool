...
- `--insert-mode`: `Insert` (default) or `Upsert` (`UPDATE OR INSERT ... MATCHING (PK)`).
...
SkyFBTool export --database "C:\data\erp.fdb" --table CUSTOMERS --insert-mode upsert --output "C:\exports\customers_upsert.sql"
```
