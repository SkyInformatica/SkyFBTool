...
Today the snapshot includes tables, columns, domains, sequences/generators, views, primary keys, unique keys, `CHECK` constraints, foreign keys, and user indexes.
