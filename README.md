...
- `ddl-extract` captures tables, columns, domains, sequences, views, procedures, stored functions, triggers, PKs, unique constraints, CHECK constraints, FKs, and user indexes into `.sql` and `.schema.json`
