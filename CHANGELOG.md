...
### Changed
- `ddl-analyze` now has an internal rule engine structure, with table structure, field compatibility, and PSQL body validations moved into dedicated rule classes.
